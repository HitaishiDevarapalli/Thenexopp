...
// High Quality Seed Fallback Rentals for immediate high-fidelity experience
const SEED_RENTAL_PROPERTIES: PropertyListing[] = [
  {
    id: 'rent_res_1',
    dealerId: 'dlr_101',
    title: '3 BHK Gated Community Luxury Apartment',
    description: 'Spacious 3 BHK luxury flat with modern amenities, wooden flooring, modular kitchen, and scenic city views. Situated in a prime gated community with 24x7 security, club house & swimming pool.',
    image: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=1000&q=80',
    image2: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=1000&q=80',
    images: [
    ...
    amenities: ['Gymnasium', 'Swimming Pool', '24x7 Power Backup', 'Gated Security', 'Clubhouse', 'Covered Parking'],
    readyToMove: true,
    urgent: true,
    agentName: 'Srinivas Rao (Verified Partner)',
    agentRating: 4.9,
  },
  {
    id: 'rent_res_2',
    dealerId: 'dlr_102',
    title: '2 BHK Fully Furnished Modern Flat',
    description: 'Fully furnished 2 BHK apartment complete with Smart TV, Sofa, ACs, Washing Machine, Refrigerators, and King Size beds. Ideal for IT working professionals & families.',
    image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=1000&q=80',
    image2: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1000&q=80',
    images: [
    ...
    amenities: ['High-speed Wi-Fi', 'Power Backup', 'Lift', 'Intercom', 'Security Guard'],
    readyToMove: true,
    agentName: 'Preeti Sharma',
    agentRating: 4.8,
  },
  {
    id: 'rent_res_3',
    dealerId: 'dlr_103',
    title: '4 BHK Grand Independent Villa with Private Garden',
    description: 'Super-luxury 4 BHK triplex villa featuring private lawn, swimming pool deck, servant room, solar power backup, and Italian marble flooring. Situated in prestigious Jubliee Hills.',
    image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1000&q=80',
    image2: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1000&q=80',
    images: [
    ...
    city: 'Hyderabad',
    area: 'Jubilee Hills',
    localityId: 'loc_jubileehills',
    latitude: 17.4319,
    longitude: 78.4072,
    price: 150000,
    priceDisplay: '₹1,50,000 / mo',
    category: 'Villa',
    status: 'Rent',
    areaSqFt: '3800',
    bedrooms: 4,
    ...
    amenities: ['Private Garden', 'Private Pool Deck', 'Solar Power', 'CCTV Security', 'Servant Quarters'],
    readyToMove: false,
    agentName: 'Rajesh Varma',
    agentRating: 4.9,
  },
  {
    id: 'rent_res_4',
    dealerId: 'dlr_104',
    title: '3 BHK Spacious Independent House',
    description: 'Independent ground floor house with car porch, dedicated private terrace access, continuous Manjeera water supply, and quiet residential neighborhood.',
    ...
    amenities: ['Terrace Access', 'Car Parking', 'Water Tanker Connection', 'Piped Gas'],
    readyToMove: true,
  ...
  },
  {
    id: 'rent_res_5',
    dealerId: 'dlr_105',
    title: '1 BHK Cozy Studio Flat for Professionals',
    description: 'Compact, fully functional 1 BHK studio flat with air conditioning, attached bath, kitchen setup, and elevator. Walking distance to Metro & tech parks.',
    ...
    amenities: ['Wi-Fi Enabled', 'Lift', 'Geyser', 'Security'],
    readyToMove: true,
    agentName: 'Venkatesh Naidu',
    agentRating: 4.8,
  },
  {
    id: 'rent_res_6',
    dealerId: 'dlr_106',
    title: 'Luxury 3 BHK Flat in Premium Society',
    description: 'High-floor 3 BHK apartment with panoramic skyline view, designer wardrobes, false ceiling LED lighting, and modular island kitchen.',
    ...
    amenities: ['Gym', 'EV Charging Station', 'Badminton Court', '24x7 Security'],
    readyToMove: true,
    agentName: 'Sandeep Menon',
    agentRating: 4.9,
  },
  {
    id: 'rent_com_1',
    dealerId: 'dlr_107',
    title: 'Plug-and-Play Furnished Corporate IT Office',
    description: 'Fully furnished corporate office space featuring 45 modular workstations, 4 executive director cabins, 12-seater conference room, reception counter, pantry & server room.',
    image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1000&q=80',
    image2: 'https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&w=1000&q=80',
    images: [
    ...
    localityId: 'loc_financialdist',
    latitude: 17.4140,
    longitude: 78.3435,
    price: 125000,
    priceDisplay: '₹1,25,000 / mo',
    category: 'Commercial',
    status: 'Rent',
    areaSqFt: '2500',
    bedrooms: 0,
    ...
    amenities: ['Centralized AC', '100% Power Backup', 'High Speed Elevators', 'Biometric Entry', 'Fire Safety Sprinklers'],
    readyToMove: true,
    urgent: true,
    agentName: 'NexOpp Commercial Advisory Desk',
    agentRating: 5.0,
  },
  {
    id: 'rent_com_2',
    dealerId: 'dlr_108',
    title: 'High Footfall Main Road Retail Showroom',
    description: 'Ground floor retail showroom with 35 ft frontage on high-density main road. Excellent visibility for retail brands, boutiques, jewelers, or electronics outlets.',
    ...
    city: 'Hyderabad',
    area: 'Madhapur',
    localityId: 'loc_madhapur',
    latitude: 17.4483,
    longitude: 78.3915,
    price: 210000,
    priceDisplay: '₹2,10,000 / mo',
    category: 'Commercial',
    status: 'Rent',
    areaSqFt: '1800',
    bedrooms: 0,
    ...
    amenities: ['Main Road Frontage', 'Customer Parking', 'Three Phase Power', 'Signage Board Space'],
    readyToMove: true,
    agentName: 'Murali Krishna',
    agentRating: 4.8,
  },
  {
    id: 'rent_com_3',
    dealerId: 'dlr_109',
    title: 'Industrial Warehouse & Logistics Space',
    description: 'Heavy duty RCC structure warehouse with 24ft clear ceiling height, dock levellers, container accessibility, and round-the-clock security setup.',
    ...
    city: 'Hyderabad',
    area: 'Patancheru',
    localityId: 'loc_patancheru',
    latitude: 17.5273,
    longitude: 78.2642,
    price: 180000,
    priceDisplay: '₹1,80,000 / mo',
    category: 'Commercial',
    status: 'Rent',
    areaSqFt: '12000',
    bedrooms: 0,
    ...
    amenities: ['Heavy Vehicle Docking', 'CCTV System', 'Industrial Power', 'Worker Rest Area'],
    readyToMove: true,
...
export const RentPropertyPage: React.FC<RentPropertyPageProps> = ({
  ...
  // Combine propertiesDb rentals with SEED_RENTAL_PROPERTIES ensuring richness
  const allRentalProperties = useMemo(() => {
    const dbRentals = (propertiesDb || []).filter(p => {
      const statusLower = (p.status || '').toLowerCase();
      const catLower = (p.category || '').toLowerCase();
      return statusLower === 'rent' || statusLower === 'lease' || catLower.includes('rent');
    });

    const dbMap = new Map(dbRentals.map(p => [p.id, p]));
    SEED_RENTAL_PROPERTIES.forEach(seedProp => {
      if (!dbMap.has(seedProp.id)) {
        dbMap.set(seedProp.id, seedProp);
      }
    });
                  ...
                  {filteredRentals.map(prop => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <img
                            src={prop.image || prop.imageUrl || 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=800&q=80'}
                            alt={prop.title}
