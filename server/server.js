  ...
  try {
    ...
    const created = await prisma.broker.create({
      data: {
        ...
        state: d.state || (Array.isArray(d.serviceAreas) && d.serviceAreas[0] && d.serviceAreas[0].state) || null,
        district: d.district || (Array.isArray(d.serviceAreas) && d.serviceAreas[0] && d.serviceAreas[0].district) || null,
        city: d.city || (Array.isArray(d.serviceAreas) && d.serviceAreas[0] && d.serviceAreas[0].city) || null,
